...
public class Adresse implements Serializable {
	...
	@Id
	@GeneratedValue(generator = "adresse_sequence_name")
	@SequenceGenerator(name = "adresse_sequence_name", sequenceName = "adresse_adress_id_seq", allocationSize = 1)
	@Column(name = "adress_id", unique = true, nullable = false, updatable = false)
